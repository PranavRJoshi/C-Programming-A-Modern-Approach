...
int part_compare (const void *element_1, const void *element_2);
...
int part_compare (const void *element_1, const void *element_2) {
  const struct part *ele_1 = element_1;
  const struct part *ele_2 = element_2;

  if (ele_1->number > ele_2->number) {
    return 1;
  } else if (ele_1->number < ele_2->number) {
    return -1;
  } else {
    return 0;
  }
